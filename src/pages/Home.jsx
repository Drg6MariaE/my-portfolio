...
export default function Home() {
  return (
      ...
      <div className='intro'>
        ...
        <p className="home__subtitle">I’m a passionate web developer, dedicated to growing my skills and reaching my full potential. In this portfolio, you’ll find a selection of projects that showcase my creativity, dedication, and technical abilities.</p>
        <button className='home__btn'><Link to='/projects'>See my work</Link></button>
      </div>
    ...
    <section className='showcase'>
      <div className='showcaseintro'>
        ...
        <p>This is a Figma-based design concept for a coffee shop website, showcasing my skills in layout
        planning, visual hierarchy, and user-centered design.</p>
      </div>
      </div>
      <div className='showcase1'>
        <p> This project is part of my personal portfolio and represents a key step in my development journey. It not only demonstrates my ability to translate design mockups into fully responsive, real-world web interfaces, but also showcases my evolving skills in layout design, user experience, and front-end technologies.</p>
      ...
      <p>I’m a self-taught web developer with a passion for building clean, responsive websites. I love turning ideas into interactive, user-friendly web experiences.<br></br><br></br>
